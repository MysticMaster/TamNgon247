...
fun AppNavHost(context: Context) {
    ...
    val dishViewModel = DishViewModel(context)
...
//       startDestination = Route.AdminBottomAppBar.screen
        ...
        composable(Route.CustomerLogin.screen) {
            CustomerLoginScreen(
                navController = navController,
                loginViewModel
            )
        }
        composable(Route.AdminLogin.screen) { AdminLoginScreen(navController, loginViewModel) }
        ...
        composable(Route.CategoryManager.screen) {
        ...
        composable(Route.DishManager.screen) {
            DishManagerScreen(
                context = context,
                navController = navController,
