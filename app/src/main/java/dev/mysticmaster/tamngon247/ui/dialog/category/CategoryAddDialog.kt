                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            ...
                            val categoryItemRequest = CategoryItemRequest(categoryName, "chuaco", true)
                            Log.e("TAG","newCategory: ${categoryItemRequest}")
                            categoryViewModel.addCategory(categoryItemRequest)
                            onDismiss()
                        },
